...
const FAQ_ITEMS = [
  {
    question: "How does the 7-day free trial work?",
    answer:
      "When you sign up for the annual plan, you won't be charged anything for the first 7 days. You can cancel at any time within the trial period from your account portal, and you won't owe a dime.",
  },
  {
    question: "Can I switch between monthly and annual plans?",
    answer:
      "Yes! You can easily upgrade or downgrade your active plan at any time through your billing settings dashboard.",
  },
  {
    question: "Is Summarist Premium really refundable?",
    answer:
      "We offer a 14-day money-back guarantee if you are not fully satisfied with your premium experience outside of your trial window.",
  },
];
...
export default function ChoosePlanPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      console.log(
        `Redirecting to checkout for plan: ${selectedPlan.name} (${selectedPlan.id})`
      );
    } catch (error) {
      console.error("Checkout failed:", error);
    } finally {
